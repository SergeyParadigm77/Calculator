...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String[] romeDigits = new String[]{"I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII", "XIII", "XIV", "XV", "XVI", "XVII", "XVIII", "XIX", "XX"};
        ...
        {
            if (Integer.valueOf(calculation[0]) < 1 || Integer.valueOf(calculation[0]) > 10 || Integer.valueOf(calculation[2]) < -10 || Integer.valueOf(calculation[2]) > 10)
            {
                throw new IOException();
                //System.out.println("Some digits are too big! You can input only 1 or 10 max!");
            }
            else
            {
